...
if(isset($_POST['nom']) && isset($_POST['pass'])){
	if($_POST['nom'] == admin && $_POST['pass'] == admin){
		$bool = true;
	}else{
		$bool = false;
	}
...
<body>
   <div id="container">
		...
		<a href='index.php'>Erreur d'identification , clicker ici pour retourner au menu d'identification</a>
	    ...
	    ?>
		  ...
		  <ul>
		  	<li><a href='AccueilRetour.php'>Retour Cassettes</a></li>
		  	<li><a href='Accueil.php'>Enregistrer un nouveau abonné</a></li>
		  	<li><a href='Accueil.php'>Modifier des fiches d'abonnés</a></li>
		  	<li><a href='Accueil.php'>Radier des abonnés</a></li>
		  </ul>
		<?php  
	    }
	    ?>     
